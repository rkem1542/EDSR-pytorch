...
class RCAN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
       ...
       #define another flow of pooling module, pool_depth=3
        modules_pool1 = [nn.MaxPool2d(kernel_size=2, stride=2)]
        modules_pool2 = [nn.MaxPool2d(kernel_size=2, stride=2)]
        ...
        self.pool1 = nn.Sequential(*modules_pool1)
        self.pool2 = nn.Sequential(*modules_pool2)
